...
- **Banque de questions à variantes réelles** (`lib/question-templates.ts`,
  ...
  qualitatives) : 700 templates (en cours d'enrichissement vers ≥ 12
...
content/question-templates/   700 templates de questions à variantes (95 notions, enrichissement en cours vers ≥12/notion), serveur uniquement — sauf build GitHub Pages
