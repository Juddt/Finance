...
- **Banque de questions à variantes réelles** (`lib/question-templates.ts`,
  ...
  qualitatives) : 740 templates (en cours d'enrichissement vers ≥ 12
...
content/question-templates/   740 templates de questions à variantes (95 notions, enrichissement en cours vers ≥12/notion), serveur uniquement — sauf build GitHub Pages
