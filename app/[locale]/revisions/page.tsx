  ...
  return (
    <div className="flex-1">
      <div className="mx-auto w-full max-w-2xl px-4 py-10 sm:px-6">
        <h1 className="text-3xl leading-[1.1] font-extrabold tracking-tight sm:text-4xl">{dict.revisionsPage.title}</h1>
        <p className="mt-4 max-w-xl text-text-dim">{dict.revisionsPage.subtitle}</p>
      </div>
